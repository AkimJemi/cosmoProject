...
<body>
	...
	<input type="hidden"
		value="${ ctxPath = pageContext.request.contextPath }" /> ${errors.no }
	|| ${errors.water_ind } || ${errors.ele_basic } || ${errors.ele_ind }
	||<%=request.getAttribute("readOnly")%>
	//
	<%=readOnly%>
		...
		<div class="Container_Main">
			<div class="Container_Inner">
				...
				<div class="Container_Box">
					...
					<input type="text" name="water_ind" value="${subReq.water_ind }"
						<%=readOnly%> />

				</div>
				<div class="Container_Box">
					<div class="Container_label">전기 기본세 :</div>
					<input type="text" name="ele_basic" value="${subReq.ele_basic }"
						<%=readOnly%> />

				</div>
				<div class="Container_Box">
					<div class="Container_label">전기 개인세 :</div>
					<input type="text" name="ele_ind" value="${subReq.ele_ind }"
						<%=readOnly%> />
				</div>
				<div class="Container_label">
					...
					%>
					<input type="button" value="추가 등록"
						onclick="location.href = 'subRead.do'" /> <input type="button"
						value="수정"
						onclick="location.href = 'subModify.do?no=${subReq.no }'" />
					<%
					} else {
					%>
